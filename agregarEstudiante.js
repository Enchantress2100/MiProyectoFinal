...
const ae = async (curso, rut, nombre, apellidos, edad, fechaNacimiento, foto, apoderado, numeroApoderado, direccion,alergias,salud) => {
  ...
  const res = await client.query(
    `INSERT INTO estudiantes(rut,nombre,apellidos,edad,fechaNacimiento,foto) VALUES('${rut}','${nombre}','${apellidos}','${edad}','${fechaNacimiento}','${foto}');
